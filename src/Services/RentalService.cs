...
public class RentalService : IRentalService
{
    ...
    private readonly List<string> _depotNotes = new();
    ...
    public IReadOnlyList<string> GetNotes() => _depotNotes;
    ...
    public Rental BookRental(CreateRentalRequest request)
    {
        ...
        string depotNote = $"DEPOT -> Prepare {rental.VehicleClass} for {rental.CustomerName}, pickup {rental.PickupDate}.";
        _depotNotes.Add(depotNote);
